...
//
// The key carries a .json extension — it is an alert-clip manifest, not raw
// video bytes.  Video bytes live in the recordings bucket only.
...
describe("s3KeyForAlertClip", () => {
  it("rounds 27.5s to the 30s boundary (nearest-10s, rounds up)", () => {
    ...
    //         == "cam-01/2026-05-15T14-03-30.json"
  ...
  it("rounds 24s down to the 20s boundary (under 5s past boundary)", () => {
    ...
    //         == "cam-01/2026-05-15T14-03-20.json"
